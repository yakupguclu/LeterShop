    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdctCategory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProdctCategory_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdctCategory_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdctCategory_CategoryId",
                table: "ProdctCategory",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProdctCategory_ProductId",
                table: "ProdctCategory",
                column: "ProductId");
